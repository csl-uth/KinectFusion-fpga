...
inline __host__     __device__ floatH3 make_floatH3(floatH4 a) {
	return make_floatH3(a.x, a.y, a.z);
}
...
inline __host__     __device__ uint min(uint2 a) {
	return min(a.x, a.y);
}
inline __host__     __device__ uint min(uint3 a) {
	return min(a.x, min(a.y, a.z));
}
inline __host__     __device__ uint min(uint4 a) {
...
inline __host__     __device__ uint max(uint2 a) {
	return max(a.x, a.y);
}
inline __host__     __device__ uint max(uint3 a) {
...
#ifdef NE10
	//ne10_dot_vec2f(ptrToResult, ptrFirstTerm,ptrSecondTerm,Len);

	float result;
	ne10_dot_vec2f(&result, (ne10_vec2f_t *)&a,(ne10_vec2f_t *)&b,1);
	return result;
#else
...
inline __host__ __device__ float dot(float3 a, float3 b) {
	...
	float result;
	ne10_dot_vec3f(&result, (ne10_vec3f_t *)&a,(ne10_vec3f_t *)&b,1);
	return result;
#else
	return a.x * b.x + a.y * b.y + a.z * b.z;
#endif
}
inline __host__ __device__ floatH dot(floatH3 a, floatH3 b) {
	return a.x * b.x + a.y * b.y + a.z * b.z;
}
inline __host__ __device__ float dot(float4 a, float4 b) {
	...
	float result;
	ne10_dot_vec4f(&result, (ne10_vec4f_t *)&a,(ne10_vec4f_t *)&b,1);
	return result;
#else
...
#ifdef NE10
	float result;
	ne10_len_vec2f(&result,(ne10_vec2f_t*)&v,1);
	return result;
#else
...
#ifdef NE10 
	float result;
	ne10_len_vec3f(&result,(ne10_vec3f_t*)&v,1);
	return result;
#else
	return sqrtf(dot(v, v));
#endif
...
#ifdef NE10
	float result;
	ne10_len_vec4f(&result,(ne10_vec4f_t*)&v,1);
	return result;
#else 
	return sqrtf(dot(v, v));
#endif
